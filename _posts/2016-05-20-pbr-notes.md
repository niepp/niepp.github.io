...
$$
$$k_d$$对应diffuse部分，$$k_s$$对应specular部分
...
$$L_o(p,\omega_{o})=k_d(\frac{\rho}{\pi})∫_{ \Omega}L_{i}(p,\omega_{i})n⋅\omega_{i}d\omega_{i}$$，转到球面坐标下$$d\omega_{i}=sin(\theta)d{\theta}d{\phi}$$     

，其中 $${\theta}\in[0,{\pi}/2],{\phi}\in [0, 2{\pi}] $$ ，为了球面均匀采样，再做积分换元[6]，
$$
...
![](../../../images/prefilter_mips.png)

1. 第二部分是brdf-lut，也可以用函数拟合方式计算（ 使命召唤黑色行动2）
| ![](../../../images/integrateBRDF_lut.png)|
| ------------------------------------------------------------ |
...
4. https://google.github.io/filament/Filament.html
5. http://www.codinglabs.net/article_physically_based_rendering.aspx
6. https://seblagarde.wordpress.com/2011/08/17/hello-world/
7. [http://www.sztemple.cc/articles/pbr%e7%90%86%e8%ae%ba%e4%bd%93%e7%b3%bb%e6%95%b4%e7%90%86%ef%bc%88%e4%b8%89%ef%bc%89%ef%bc%9aibl](http://www.sztemple.cc/articles/pbr理论体系整理（三）：ibl)
...
9. https://en.wikipedia.org/wiki/Inverse_transform_sampling
10. https://dk81.github.io/dkmathstats_site/prob-inverse-cdf.html
11. https://www.cnblogs.com/timlly/p/10631718.html